Create an anaconda environment using `conda env create -f env.yml`. Then, activate the environment using `conda activate aemf`. If everything worked, you should be good to go.
